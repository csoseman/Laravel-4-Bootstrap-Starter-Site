    ...
    <div class="logmod__wrapper">
        ...
        <div class="logmod__container">
            <ul class="logmod__tabs">
                <li class="current" data-tabtar="lgm-2"><a href="#">Login</a></li>
                <li class="" data-tabtar="lgm-1"><a href="#">Sign Up</a></li>
            </ul>
                        ...
                        <form accept-charset="utf-8" action="#" class="simform">
                            <div class="sminputs">
                                <div class="input full">
                                    ...
                                    <input class="string optional" maxlength="255" id="user-email" placeholder="Email" size="50" type="email">
                                </div>
                            </div>
                            <div class="sminputs">
                                <div class="input string optional">
                                    <label class="string optional" for="user-pw">Password *</label>
                                    <input class="string optional" maxlength="255" id="user-pw" placeholder="Password" size="50" type="text">
                                </div>
                                <div class="input string optional">
                                    <label class="string optional" for="user-pw-repeat">Repeat password *</label>
                                    <input class="string optional" maxlength="255" id="user-pw-repeat" placeholder="Repeat password" size="50" type="text">
                                </div>
                            </div>
                            <div class="simform__actions">
                                <input class="sumbit" name="commit" value="Create Account" type="sumbit">
                    ...
                    <div class="logmod__form">
                        <form accept-charset="utf-8" action="#" class="simform">
                            ...
                            <div class="sminputs">
                                <div class="input full">
                                    <label class="string optional" for="user-pw">Password *</label>
                                    <input class="string optional" maxlength="255" id="user-pw" placeholder="Password" size="50" type="password">
                                    <span class="hide-password">Show</span>
                                </div>
                            </div>
                            <div class="simform__actions">
                                <input class="sumbit" name="commit" value="Log In" type="sumbit">
